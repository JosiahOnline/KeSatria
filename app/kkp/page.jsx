    ...
    <Box>
      ...
      <Box
        ...
        <Typography variant="h6" gutterBottom width="50%">
          FFB COLLECTING CENTRE • PLANTATION MANAGEMENT • HUMAN RESOURCE
          MANAGEMENT{" "}
        </Typography>
        <Grid
          container
          ...
          <Grid item xs={12} md={4} align="center">
            ...
            <Box
              ...
              <Box
                ...
                <Link href="/Kang Ke Palm Sdn Bhd Profile.pdf">
                  <CardMedia
                    sx={{
                      height: "100px",
                      width: "80px",
        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <Button
              ...
              size="lg"
              component="a"
              href="https://wa.me/60108818233?text=Hi,%20I%20want%20to%20know%20more%20about%20Kang%20Ke%20Palm%20Sdn%20Bhd!"
            ...
            <Button
              ...
              component="a"
              onClick={() =>
                (window.location = "mailto:financekangkepalmsdnbhd@gmail.com")
              }
              endIcon={<EmailIcon />}>
              Email Us
            </Button>
